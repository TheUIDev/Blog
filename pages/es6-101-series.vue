<template>
  <v-layout column justify-center align-center>
    <v-flex xs12 sm8 md6>
      ...
      <p>
        Following is a list of articles in the ES6 101 series. Every article
        post has detailed explanation of the concepts and I have used working
        code samples to make sure that each concept is conceptualy cleared. Hope
        you enjoy this series! 😎 😉 Feedback, coments and shares are always
        welcome!
      </p>
